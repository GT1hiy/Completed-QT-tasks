...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        video_output->setEnabled(true);
        QSizePolicy sizePolicy1(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy1.setHorizontalStretch(20);
        sizePolicy1.setVerticalStretch(50);
        sizePolicy1.setHeightForWidth(video_output->sizePolicy().hasHeightForWidth());
        video_output->setSizePolicy(sizePolicy1);
        ...
        sizePolicy.setHeightForWidth(btn_pause->sizePolicy().hasHeightForWidth());
        btn_pause->setSizePolicy(sizePolicy);
        btn_pause->setMinimumSize(QSize(0, 24));
        ...
        verticalLayout->addWidget(btn_choose);
        ...
        sld_volume->setLayoutDirection(Qt::LeftToRight);
        sld_volume->setMaximum(100);
        sld_volume->setValue(100);
        sld_volume->setTracking(true);
        sld_volume->setOrientation(Qt::Vertical);
        sld_volume->setInvertedAppearance(false);
        sld_volume->setInvertedControls(false);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btn_pause->setText(QCoreApplication::translate("MainWindow", "\342\217\265", nullptr));
