...
public:
    ...
    void setupUi(QMainWindow *Selector)
    {
        ...
        gridLayout_4->addLayout(horizontalLayout_17, 0, 2, 1, 1);
        ...
        gridLayout_4->addLayout(horizontalLayout_11, 1, 1, 1, 1);
        ...
        gridLayout_4->addLayout(horizontalLayout_16, 2, 1, 1, 1);
        ...
        gridLayout_4->addLayout(horizontalLayout_4, 4, 2, 1, 1);
        ...
        verticalLayout_8->addWidget(pb_vegetable);

        pb_drink = new QPushButton(centralWidget);
        pb_drink->setObjectName("pb_drink");

        verticalLayout_8->addWidget(pb_drink);

        pb_fruit = new QPushButton(centralWidget);
        pb_fruit->setObjectName("pb_fruit");

        verticalLayout_8->addWidget(pb_fruit);

        verticalSpacer = new QSpacerItem(85, 30, QSizePolicy::Minimum, QSizePolicy::Preferred);
    ...
    void retranslateUi(QMainWindow *Selector)
    {
        ...
        label->setText(QCoreApplication::translate("Selector", "<html><head/><body><p align=\"center\">\320\224\320\276\320\261\320\260\320\262\320\270\321\202\321\214</p></body></html>", nullptr));
